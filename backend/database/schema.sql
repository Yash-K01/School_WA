...
CREATE TABLE application (
  ...
  SET NULL,
    ...
    assigned_to BIGINT REFERENCES app_user(id) ON DELETE
  SET NULL,
...
CREATE TABLE application_documents (
  ...
  rejection_reason TEXT,
  uploaded_by BIGINT REFERENCES app_user(id) ON DELETE
  SET NULL,
    verified_by BIGINT REFERENCES app_user(id) ON DELETE
  SET NULL,
...
CREATE TABLE audit_log (
  id BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
  school_id BIGINT NOT NULL REFERENCES school(id) ON DELETE CASCADE,
  user_id BIGINT REFERENCES app_user(id) ON DELETE
  SET NULL,
...
ADD COLUMN application_id BIGINT REFERENCES application(id) ON DELETE
SET NULL;
